...
static uint16_t           BUTTON_PIN[BUTTONn]  = {B1_PIN,B2_PIN};
static GPIO_TypeDef      *BUTTON_PORT[BUTTONn] = {B1_GPIO_PORT,B2_GPIO_PORT};
static IRQn_Type          BUTTON_IRQn[BUTTONn] = {B1_EXTI_IRQn,B2_EXTI_IRQn};
...
//  }
  ...
  if (ButtonMode == BUTTON_MODE_EXTI)
  {
    ...
    HAL_NVIC_SetPriority(BUTTON_IRQn[Button], NVIC_HIGH_PRIORITY, 0);
